...
<h1>Temperatura : <?php echo round($json_data['data']['sensors'][3]['value']) ; ?> Grados Celcius</h1>
<h1>Bateria : <?php echo $json_data['data']['sensors'][1]['value'] ; ?> %</h1>
<h1>Humedad : <?php echo round($json_data['data']['sensors'][2]['value']) ; ?> %</h1>
