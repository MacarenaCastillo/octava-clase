...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php for ($n = 0; $n < $all; $n++) {?>
    <?php if (substr_count($json_data['features'][$n]['properties']['place'],'Chile' ) > 0 && $json_data['features'][$n]['properties']['mag'] >= 4){?>
    <?php $cl++ ;?>
    <li
    <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:RGB(224, 0, 0);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5.5){ ?> style="color:RGB(255, 76, 76);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(255, 119, 119);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4.5){ ?> style="color:RGB(147, 85, 85);"  <?php }else{ ?> style="color:RGB(175, 114, 117);" <?php } ;?>>
